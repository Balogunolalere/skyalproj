...
export const CONTACT_DETAILS = [
  { label: "Email", value: "sales@skyallaser.com", href: "mailto:sales@skyallaser.com" },
  { label: "Phone", value: "0803 500 3068", href: "tel:+2348035003068" },
...
export const REFUND_SECTIONS = [
  ...
  { id: "2.0", title: "How to Request a Refund", content: "To request a refund, contact us at sales@skyallaser.com or through the Support chat on our platform. Include your order number, a description of the issue, and any supporting photos or documentation.\n\nWe will acknowledge your refund request within 24 hours and process eligible refunds within 3–5 business days. Refunds are issued to the original payment method used during checkout." },
